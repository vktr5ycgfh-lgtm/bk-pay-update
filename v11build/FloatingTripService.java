...
public class FloatingTripService extends Service implements LocationListener {
    ...
    private Button startBtn, pickedBtn, waitBtn;
    ...
    private void createOverlay() {
        ...
        bubble.setLines(2);
        bubble.setBackground(bg(0xff075985,39,0xff38bdf8));
        ...
        bubble.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, android.view.MotionEvent e) {
                if(e.getAction()==MotionEvent.ACTION_DOWN){downX=e.getRawX();downY=e.getRawY();startX=lp.x;startY=lp.y;downT=System.currentTimeMillis();return true;}
                ...
                if(e.getAction()==MotionEvent.ACTION_UP){
                    ...
                    if(dx<12&&dy<12&&System.currentTimeMillis()-downT<500) menu.setVisibility(menu.getVisibility()==View.VISIBLE?View.GONE:View.VISIBLE);
                    return true;
                }
                return false;
            }
    ...
    private void dutyOff() {
        ...
        if(root!=null){try{wm.removeView(root);}catch(Exception ignored){}root=null;}
    ...
    private void updateBubble() {
        ...
        startBtn.setAlpha(startBtn.isEnabled()?1f:.45f);pickedBtn.setAlpha(pickedBtn.isEnabled()?1f:.45f);waitBtn.setAlpha(waitBtn.isEnabled()?1f:.45f);
    }
    ...
    @Override public void onDestroy() {
        ...
        stopLocation();if(handler!=null&&ticker!=null)handler.removeCallbacks(ticker);if(root!=null){try{wm.removeView(root);}catch(Exception ignored){}root=null;}super.onDestroy();
    }

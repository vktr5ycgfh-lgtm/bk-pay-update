...
public class MainActivity extends Activity {
    ...
    public class RiderBridge {
        ...
        @JavascriptInterface public void updateFloatingUi(boolean compact, boolean haptic, boolean autoCollapse) {
            getSharedPreferences(FloatingTripService.PREFS, Context.MODE_PRIVATE).edit()
                .putBoolean("bubbleCompact", compact)
                .putBoolean("bubbleHaptic", haptic)
                .putBoolean("bubbleAutoCollapse", autoCollapse)
                .apply();
